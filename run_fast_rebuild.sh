...
# run_fast_rebuild.sh
# Run multiple fast batch processing sessions with reporting
# Usage: ./run_fast_rebuild.sh [BATCH_COUNT] [CHUNKS_PER_BATCH]

# Configuration
BATCH_COUNT=${1:-10}        # Number of batches to run (default: 10)
CHUNKS_PER_BATCH=${2:-5}    # Number of chunks per batch (default: 5)
PAUSE_BETWEEN=3             # Pause between batches in seconds

echo "=============================================="
echo "FAST BATCH REBUILD CONTROLLER"
echo "=============================================="
...
chmod +x fast_batch_processor.sh
...
for ((batch=1; batch<=BATCH_COUNT; batch++)); do
    ...
    ./fast_batch_processor.sh $CHUNKS_PER_BATCH
...
echo ""
echo "=============================================="
echo "ALL FAST BATCHES COMPLETE"
echo "=============================================="
